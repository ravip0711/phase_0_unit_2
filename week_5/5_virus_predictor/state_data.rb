...
#These hashes point the key (which are the states), to symbol variables. I presume that when called for the state key, it will return the elements within that key.
